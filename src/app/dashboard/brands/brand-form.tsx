...
const brandSchema = z.object({
  name: z.string().min(2, "Brand name must be at least 2 characters").max(50, "Brand name must be less than 50 characters"),
});
...
export function BrandForm() {
  ...
  const { register, handleSubmit, reset, formState: { errors } } = useForm<z.infer<typeof brandSchema>>({
